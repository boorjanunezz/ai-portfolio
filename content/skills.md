...
- SQL — consultas y administración de bases de datos en Azure
...
- Azure Document Intelligence — extracción de datos de PDFs
- Prompt engineering, fine-tuning y guardrails
- TensorFlow y Keras — redes ANN, CNN y LSTM
- Gemini API — asistente del portfolio
- HuggingFace Inference API — Qwen 2.5 72B
- Ollama y Open WebUI — modelos locales
- n8n — automatizaciones y bots con IA
...
- Microsoft Fabric — ingeniería de datos
- Azure Machine Learning — entrenamiento y despliegue de modelos
- SQL Server y Azure SQL — modelado y administración
- Supabase — base de datos y vectores
- Streamlit — apps y demos de datos
